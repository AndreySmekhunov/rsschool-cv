const birdsData = [
    ...
    [
      ...
      },
      {
        ...
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/American_White_Pelican%2C_non-breeding_adult_%2838164183581%29.jpg/275px-American_White_Pelican%2C_non-breeding_adult_%2838164183581%29.jpg',
  ...
  for (let i = 0; i < birdsData.length; i++) {
    for (let j = 0; j < birdsData[i].length; j++) {
      let oneBird = {}
      oneBird.name = birdsData[i][j].name;
      oneBird.species = birdsData[i][j].species;
